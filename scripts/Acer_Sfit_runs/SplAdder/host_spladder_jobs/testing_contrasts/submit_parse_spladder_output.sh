...
cont_sheet="/proj/omics4tb2/kstankiewicz/scratch/alt_splice/GS_Pilot_Acer/scripts/SplAdder/host_spladder_jobs/testing_contrasts/all_contrasts.txt"
...
Rscript ${PWD}/run_parse_spladder_output.R ${var1} ${var2} ${const}
