...
spladder test -o ${out} --out-tag control --conditionA ${tests}/clean_${1}_test.txt --conditionB ${tests}/clean_${2}_test.txt --labelA ${1} --labelB ${2} --diagnose-plots -v --parallel 5
