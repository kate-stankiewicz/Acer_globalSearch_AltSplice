...
cont_sheet="/proj/omics4tb2/kstankiewicz/scratch/alt_splice/GS_Pilot_Acer/scripts/Acer_Sfit_runs/SplAdder/sym_spladder_jobs/testing_contrasts/fail_pass_concat/rem_off_samp/contrast_files/all_contrasts.txt"
