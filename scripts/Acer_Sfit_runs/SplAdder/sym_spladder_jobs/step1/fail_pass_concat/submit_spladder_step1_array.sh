...
dir='/proj/omics4tb2/kstankiewicz/scratch/alt_splice/GS_Pilot_Acer/results/SplAdder/sym_spladder_res'
samplesheet='/proj/omics4tb2/kstankiewicz/scratch/alt_splice/GS_Pilot_Acer/scripts/SplAdder/sym_spladder_jobs/sym_bams_all.txt'
samp=`sed -n "$SLURM_ARRAY_TASK_ID"p $samplesheet |  awk '{print $1}'`

#make results directories
mkdir -p ${dir}/array_spladder_out2
mkdir -p ${dir}/array_spladder_out2/spladder
mkdir -p ${dir}/array_spladder_out2/tmp
