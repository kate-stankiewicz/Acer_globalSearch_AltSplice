...
# parse the array
samplesheet='/proj/omics4tb2/kstankiewicz/scratch/alt_splice/GS_Pilot_Acer/scripts/RNAseq_pipeline/count_mapped_reads/add_fail_samples_host/fail_sample_species_list.txt'
